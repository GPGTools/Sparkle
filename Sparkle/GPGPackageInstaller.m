...
- (BOOL)checkPackage:(NSString *)pkgPath error:(NSError * __autoreleasing *)error {
    ...
    const uint8_t gpgtoolsCertHashBytes[] = {
        0xA8, 0xD5, 0x2E, 0xB1, 0xC1, 0x49, 0x48, 0xB8, 0x44, 0xD3, 0xAE, 0xA6, 0x0E, 0xE2, 0x09, 0x1F,
        0x00, 0x2E, 0x84, 0xA2, 0xC8, 0x94, 0xC3, 0x31, 0xB1, 0x13, 0xA3, 0xD5, 0x07, 0x01, 0x48, 0x8D,
        0xBE, 0x86, 0x7D, 0x67, 0xB4, 0x7A, 0x0D, 0x5E, 0x5D, 0xD2, 0xAB, 0x74, 0x43, 0x1F, 0xD5, 0x0F,
        0xEF, 0x2F, 0x7E, 0x59, 0x6D, 0x11, 0xB6, 0x56, 0xB5, 0xF0, 0x64, 0xC8, 0xC2, 0x16, 0x1C, 0x65
    };
